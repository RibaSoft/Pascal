...
resourceString
  ...
  rsMtCustom       = 'Customomizar';

  // file dialog
  rsfdOpenFile           = 'Abrir arquivo existente';
  rsfdOverwriteFile      = 'Sobrescrever Arquivo?';
  rsfdFileAlreadyExists  = 'O arquivo "%s" já existe. Deseja sobrescreve-lo?';
  rsfdPathMustExist      = 'Local deve existir';
  rsfdPathNoExist        = 'O local "%s" não existe.';
  rsfdFileMustExist      = 'Arquivo deve exixtir';
  ...
  rsFind = 'Find';
  rsfdFileReadOnlyTitle  = 'Arquivo não é editavél';
  rsfdFileReadOnly       = 'O arquivo "%s" não é esditável.';
  rsfdFileSaveAs         = 'Salvar arquivo como';
  rsAllFiles = 'Todos arquivos (%s)|%s|%s';
  rsfdSelectDirectory    = 'Selecione a Pasta';
  rsDirectory            = '&Pasta';

  // Select color dialog
  rsSelectcolorTitle    = 'Selecione a cor';
   
  // Select font dialog
  rsSelectFontTitle     = 'Selecione uma fonte';
  rsFindMore = 'Procurar mmais';
